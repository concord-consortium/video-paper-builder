...
gem "childprocess", "1.0.1"      # pin to ensure cucumber-rails doesnt resolve to using ruby > 2.2
gem "public_suffix", "3.1.1"     # pin to ensure launchy doesnt resolve to using ruby 2.3
gem "rack-cache", "1.9.0"        # pin to ensure devise_invitable doesnt resolve to using ruby 2.3
